...
public class MoussaillonController {
	...
	private MoussaillonService moussaillonservice ;
	 ...
	 @GetMapping(path ="/moussaillon", produces = MediaType.APPLICATION_JSON_VALUE)
	   public @ResponseBody List<Moussaillon> getAllMoussaillons(){
	       return moussaillonservice.findAll();
	   }
